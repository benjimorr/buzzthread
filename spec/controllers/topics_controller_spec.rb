...
RSpec.describe TopicsController, type: :controller do
   ...
   context "member user" do
       before do
           user = User.create!(name: "Buzzthread User", email: "user@buzzthread.com", password: "password", role: :member)
           create_session(user)
       end
  ...
  context "moderator user" do
      before do
          user = User.create!(name: "Buzzthread User", email: "user@buzzthread.com", password: "password", role: :moderator)
          create_session(user)
      end
  ...
  context "admin user" do
      before do
          user = User.create!(name: "Buzzthread User", email: "user@buzzthread.com", password: "password", role: :admin)
          create_session(user)
      end
